...
// Import assets using utility functions
...
const relationshipCompatibilityImage = importImage('./assets/0227397445758a002e4bcf4ac2f2d1dc50bf40e4.svg');


const page15 = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>{{title}}</title>
    ...
    <style>
      ...
      .mini-title {
        font-family: "Rethink Sans", system-ui, -apple-system, Segoe UI, Roboto, Arial,
          sans-serif;
        font-weight: 700;
        font-size: 14px;
        line-height: 100%;
      ...
      .section-circle::before, .mini-circle::before {
        padding: 7.92px;
        background: #ffffff33;
        z-index: 1;
      }
      ...
      .section-circle::after, .mini-circle::after {
        padding: 2.5px;
        background: linear-gradient(182.96deg, #ffffff -145.88%, rgba(255, 255, 255, 0) 67.92%);
        z-index: 2;
      }
      ...
      .section-progress-svg, .progress-svg {
        position: absolute;
        inset: 0;
        width: 100%;
        height: 100%;
      ...
      .section-progress-svg circle, .progress-svg circle {
        transition: stroke-dashoffset 0.3s ease;
      }

      /* --- Progress ring calculation using pathLength=100 --- */
      .progress-ring {
  ...
  <body>
    <main class="sheet">
      ...
      <div style="text-align: center; padding-top: 21px; position: relative; z-index: 2;">
      ...
      <div class="section-item" style="position: relative; z-index: 2;">
        <div class="section-header" style="align-items: center;">
          <div class="section-circle">
            <svg class="section-progress-svg" viewBox="0 0 100 100" style="--pct: {{mainSection.percentage}};">
              <defs>
                <linearGradient id="section-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stop-color="#FFA68D" />
                  <stop offset="100%" stop-color="#FD3A84" />
                </linearGradient>
              </defs>
              <circle
                cx="50"
            ...
            <img
              src="${relationshipCompatibilityImage}"
        ...
        <div class="four-circles-container">
          ...
          <div class="mini-circle-item">
            <div class="mini-circle">
              <svg class="progress-svg" viewBox="0 0 100 100" style="--pct: {{percentage}};">
                <circle
                  cx="50"
                  cy="50"
                  r="47.7"
